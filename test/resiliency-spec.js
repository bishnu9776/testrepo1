describe("Resiliency smoke tests", () => {
  ...
  describe("Pipeline resiliency", () => {
    it("Pipeline resiliency - Error parsing event or somewhere between getting gcp event and producing to kafka")

    it("Memory does not blow up by consuming too much from GCP", () => {
