...
describe("Parses LOGS", () => {
  ...
  const getParsedMessageFn = (channel, device) => (data_item_name, value, timestamp, source) => ({
    data_item_name,
  ...
  it("parses given messages", () => {
    ...
    const parsedMessage = [
      getParsedMessage("message", "log message1", 0, "vcu-s340-app"),
      getParsedMessage("message", "log message2", 1, "vcu-s340-app"),
      getParsedMessage("message", "log message3", 2, "vcu-s340-app")
    ]
